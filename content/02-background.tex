...
\improvement[inline]{Graph completion rules}
...
\todo[inline]{Do I need to define \textit{here} the solution of PGEL-SAT by the minimization problem? Isnt it better in the development chapter? }
