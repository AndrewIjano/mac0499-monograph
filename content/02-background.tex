...
% Description logics are used to represent knowledge
% concepts, roles and individuals

% examples patient and mary

% relations: axioms and assertions
...
\todo[inline]{Example about graph completion}
...
\todo[inline]{Graph completion rules; SAT is path init-bot in completed graph}
