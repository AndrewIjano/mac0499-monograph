...
\subtitulo{Algoritmos e Implementação}

\subtituloeng{Algorithms and Implementation}
...
\palavraschave{Lógicas de descrição. Polinomial. Tratável. PSAT. MaxSAT. Corte Mínimo. Programação Linear. Geração de colunas.}

\keywords{Description logics. Polynomial. Tractable. PSAT. MaxSAT. Minimal Cut. Linear Programming. Column generation.}
...
% raggedbottom apenas temporariamente.
{
  ...
  \disablenewpage{\chapter*{Abbreviations}}

  \begin{tabular}{rl}
    DL & Description logic\\
    SAT & Satisfiability problem\\
    PSAT & Probailistic satisfatibility problem\\
    $\gel$ & Graphic $\el$\\
    $\gel$-MaxSAT & Weighted partial maximum satisfiability problem for $\gel$\\
    $\pgelsat$ & Probablistic satisfiability problem for $\gel$ \\
    KB & Knowledge base\\
